function H = MGBO_Func_V(Zinit,nbits, n, L, W, P, S, B)
% 参数说明：
% 输入：
%   nbits  - 哈希码位数
%   n      - 样本量
...
opts_BPGM.mu = 1e2;%1e;              % 选择固定mu值（原代码中mu_values的默认第一个值）
...
H = OptStiefelGBB(Bk, @obj_func_ALECH_V, @moreau_hc, opts_BPGM, L, W, P, S, n, B);
